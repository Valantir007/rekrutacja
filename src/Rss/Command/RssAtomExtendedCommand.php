...
class RssAtomExtendedCommand extends Command
{
    protected static $defaultName = 'csv:extended'; //nie mozna ustawic typowania - nadpisana zmienna statyczna
    ...
    protected function configure(): void
    {
        $this
            ->setDescription(
                ...
                save to the path passed as the PATH argument. New data will be append to the end of the file.',
            )
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $logger->error(
                sprintf(
                    "Error during download extended data from url %s to path %s",
